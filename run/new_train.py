...
from transformers import AutoModelForCausalLM, AutoTokenizer, EarlyStoppingCallback, EvalPrediction
from src.data_2 import CustomDataset, DataCollatorForSupervisedDataset
...
def main(args):
  ...
  # PEFT configuration
    ...
    train_dataset = CustomDataset("resource/data/일상대화요약_train_add_spk.json", tokenizer)
    valid_dataset = CustomDataset("resource/data/일상대화요약_dev_add_spk.json", tokenizer)
